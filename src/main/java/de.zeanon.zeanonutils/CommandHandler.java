...
public class CommandHandler implements Listener, CommandExecutor {
	...
	public boolean onPlayerCommand(PlayerCommandPreprocessEvent event) {
		...
		} else if ((args[0].equalsIgnoreCase("/gamemode") || args[0].equalsIgnoreCase("/gm")) && args.length > 1 && (args[1].equalsIgnoreCase("0") || args[1].equalsIgnoreCase("1") || args[1].equalsIgnoreCase("2") || args[1].equalsIgnoreCase("3"))) {
			event.setCancelled(true);
